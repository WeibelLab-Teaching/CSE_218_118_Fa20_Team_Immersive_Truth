...
export default class Game {
    constructor(num_players, player_names) {
        ...
        this.player0 = new Player(0, player_names[0], this.subway.positions[0], this.scene)
        this.player1 = new Player(1, player_names[1], this.subway.positions[1], this.scene)
